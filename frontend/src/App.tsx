  ...
  return (
    <>
      <div className="main-container">
        ...
        <Routes>
          <Route key="featuredFundraisers" path="/" element={<FeaturedFundraisers />} />
        </Routes>
        <Routes>
          <Route key="signup" path="/signup" element={<Signup />} />
          <Route key="signupSuccess" path="/oauth/callback" element={<SignupSuccess />} />
          <Route key="profile" path="/profile/:publicAddress" element={<Profile />} />
          <Route key="allFundraisers" path="/" element={<AllFundraisers />} />
          <Route key="discoverAllFundraisers" path="/discover" element={<AllFundraisers />} />
          <Route key="createFundraiser" path="/create" element={<CreateFundraiser />} />
          <Route key="fundraiser" path="/fundraiser/:fundraiserId" element={<Fundraiser />} />
        </Routes>
